...
export default function StudyInUK() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Fetch universities
      const uniResponse = await fetch('/api/universities?country=uk')
      if (uniResponse.ok) {
      ...
      // Fetch courses
      const bachelorResponse = await fetch('/api/courses?country=uk&degreeType=bachelor')
      if (bachelorResponse.ok) {
        const bachelorData = await bachelorResponse.json()
        setBachelorCourses(bachelorData.courses || [])
      }

      const masterResponse = await fetch('/api/courses?country=uk&degreeType=master')
      ...
      // Fetch documentation
      const docResponse = await fetch('/api/documentation?country=uk')
      if (docResponse.ok) {
      ...
      // Fetch process steps
      const processResponse = await fetch('/api/process-steps?country=uk')
  ...
  const stats = [
    { icon: <GraduationCap className="w-6 h-6" />, value: "160+", label: "Universities" },
    { icon: <Euro className="w-6 h-6" />, value: "£9K-38K", label: "Tuition Range" },
    { icon: <Users className="w-6 h-6" />, value: "500K+", label: "International Students" },
    { icon: <Award className="w-6 h-6" />, value: "Top 10", label: "Global Ranking" }
  ]
  ...
  const benefits = [
    {
      ...
      description: "UK universities are globally recognized for their academic excellence and research."
    },
    {
      icon: <Globe className="w-8 h-8" />,
      title: "Global Career Opportunities",
      description: "UK degrees are highly valued by employers worldwide, opening doors to global careers."
    },
    {
      icon: <Clock className="w-8 h-8" />,
      title: "Shorter Duration",
      description: "Most UK degrees are 3 years (bachelor's) and 1 year (master's), saving time and money."
    },
    {
      icon: <BookOpen className="w-8 h-8" />,
      title: "Diverse Programs",
      description: "Wide range of specialized courses across various disciplines with flexible study options."
    }
  ]

  const docCategories = {
    visa: { icon: <FileText className="w-6 h-6" />, title: "Visa Requirements", color: "blue" },
    academic: { icon: <GraduationCap className="w-6 h-6" />, title: "Academic Documents", color: "green" },
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-white">
      ...
      {/* Navigation */}
      <GlobalNavigation currentPath="/study-in-uk" />

      {/* Hero Section */}
      <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 relative pt-16 overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-400/10 to-indigo-600/10"></div>
        ...
        <div className="max-w-7xl mx-auto text-center z-10 relative">
          ...
          <ScrollReveal direction="up" delay={0.3}>
            <p className="text-xl md:text-2xl text-gray-700 mb-12 leading-relaxed max-w-4xl mx-auto">
              Experience world-class education in the UK's prestigious universities. 
              Shorter degree programs, global recognition, and excellent career opportunities await you.
            </p>
          </ScrollReveal>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <Enhanced3DCard>
                <MicroInteractionButton
                  ...
                  size="lg"
                  className="px-12 py-4 text-lg bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white shadow-xl"
                >
                  <GraduationCap className="w-5 h-5 mr-2" />
                  Get Guidance for UK Universities
                </MicroInteractionButton>
              </Enhanced3DCard>
            ...
            <ScrollReveal direction="up" delay={0.2}>
              <div className="text-center mb-16">
                ...
                <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                  The UK offers an exceptional combination of academic excellence, cultural diversity, and global career opportunities.
                </p>
              </div>
            </ScrollReveal>
                  ...
                  <Enhanced3DCard>
                    <Card className="h-full text-center p-6 bg-white border-0 shadow-lg hover:shadow-xl transition-all duration-300">
                      <div className="flex justify-center mb-4">
                        <div className="w-16 h-16 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-full flex items-center justify-center text-white">
                          {benefit.icon}
                        </div>
                      </div>
      ...
      <section id="study-sections" className="py-20 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <ScrollReveal direction="up" delay={0.2}>
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">Your Complete UK Study Guide</h2>
              <p className="text-xl text-gray-600">Everything you need to know about studying in the UK</p>
            </div>
          </ScrollReveal>
            ...
            <TabsContent value="universities" className="space-y-6">
              <ScrollReveal direction="up" delay={0.2}>
                <div className="text-center mb-8">
                  <h3 className="text-3xl font-bold text-gray-900 mb-4">Top UK Universities</h3>
                  <p className="text-lg text-gray-600">Discover prestigious universities across the UK</p>
                </div>
              </ScrollReveal>
            ...
            <TabsContent value="master" className="space-y-6">
              <ScrollReveal direction="up" delay={0.2}>
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-gray-600">1-year postgraduate programs for advanced specialization</p>
                </div>
              </ScrollReveal>
            ...
            <TabsContent value="documentation" className="space-y-6">
              <ScrollReveal direction="up" delay={0.2}>
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-gray-600">Complete guide to all documents needed for UK study visa</p>
                </div>
              </ScrollReveal>
            ...
            <TabsContent value="process" className="space-y-6">
              <ScrollReveal direction="up" delay={0.2}>
                <div className="text-center mb-8">
                  ...
                  <p className="text-lg text-gray-600">Step-by-step guide to your UK study journey</p>
                </div>
              </ScrollReveal>
      ...
      <ParallaxContainer speed={0.1}>
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-indigo-600">
          <div className="max-w-4xl mx-auto text-center">
            <ScrollReveal direction="up" delay={0.2}>
              <h2 className="text-4xl font-bold text-white mb-6">Ready to Start Your UK Education Journey?</h2>
