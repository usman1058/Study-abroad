...
import { Menu, Home, GraduationCap, Globe, User, Mail, Phone, MapPin, BookOpen, Handshake } from 'lucide-react'
...
export default function UnifiedNavigation({ currentPath = '', className = '' }: UnifiedNavigationProps) {
